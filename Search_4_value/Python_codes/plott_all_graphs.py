...
datafile1 = '../cmake-build-debug/linear_search.txt'
datafile2 = '../cmake-build-debug/binary_search.txt'
datafile3 = '../cmake-build-debug/Tree_search.txt'
datafile4 = '../cmake-build-debug/hash_table.txt'

data = np.genfromtxt(fname=datafile1, usecols=[0, 1, 2])
data2 = np.genfromtxt(fname=datafile2, usecols=[0, 1, 2])
data3 = np.genfromtxt(fname=datafile3, usecols=[0, 1, 2])
data4 = np.genfromtxt(fname=datafile4, usecols=[0, 1, 2])
